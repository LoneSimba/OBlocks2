...
public class ItemIronSlab extends ItemBlock
{
    ...
    public ItemIronSlab(Block block)
    {
	    super(block);
	    singleSlab = OBBlocks.ironSlabSingle;
	    doubleSlab = OBBlocks.ironSlabDouble;
	    isDouble = false;
	    setMaxDamage(0);
	    setHasSubtypes(true);
    }
    ...
    private boolean func_150946_a(ItemStack p_150946_1_, EntityPlayer p_150946_2_, World p_150946_3_, int p_150946_4_, int p_150946_5_, int p_150946_6_, int p_150946_7_)
    {
	    ...
	    {
		    if (p_150946_3_.checkNoEntityCollision(this.doubleSlab.getCollisionBoundingBoxFromPool(p_150946_3_, p_150946_4_, p_150946_5_, p_150946_6_)) && p_150946_3_.setBlock(p_150946_4_, p_150946_5_, p_150946_6_, doubleSlab, j1, 3))
		    {
			    p_150946_3_.playSoundEffect((double)((float)p_150946_4_ + 0.5F), (double)((float)p_150946_5_ + 0.5F), (double)((float)p_150946_6_ + 0.5F), doubleSlab.stepSound.func_150496_b(), (doubleSlab.stepSound.getVolume() + 1.0F) / 2.0F, doubleSlab.stepSound.getPitch() * 0.8F);
